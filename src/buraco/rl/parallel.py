...
def _collect_task(
    ...
    collector.set_pool_manifest(pool_manifest)
...
class ParallelCollector:
    ...
    def __init__(
        ...
        OpponentMixture(p_heuristic, p_pool)  # validate before spawning workers
        self.cfg = cfg
    ...
    def set_pool_manifest(self, paths: list[str]) -> None:
        """Broadcast with the next collect; workers load members lazily."""
    ...
    def collect(
        ...
        for slot, worker_trajs, stats, counter_end in results:
            ...
            recorded += stats.recorded_steps
            mixed_eps += stats.mixed_episodes
            mixed_wins += stats.mixed_wins
